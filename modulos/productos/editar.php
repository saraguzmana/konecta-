    ...
    <div class="card-body">
        <form action="editar.php" method="post" enctype="multipart/form-data">
            <div class="mb-3">
                ...
                <input type="text" value="<?php echo $id; ?> " class="form-control" readonly name="id" id="id"
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" value="<?php echo $nombre; ?> " name="nombre" id="nombre"
                    aria-describedby="helpId" placeholder="Pan">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" value="<?php echo $referencia; ?>" name="referencia"
                    id="referencia" aria-describedby="helpId" placeholder="12345">

            </div>

            <div class="mb-3">
                <label for="precio" class="form-label">Precio</label>
                <input type="text" class="form-control" value="<?php echo $precio; ?>" name="precio" id="precio"
                    aria-describedby="helpId" placeholder="12000">

            </div>

            <div class="mb-3">
                <label for="peso" class="form-label">Peso (en gramos)</label>
                <input type="text" class="form-control" value="<?php echo $peso; ?>" name="peso" id="peso"
                    aria-describedby="helpId" placeholder="170">

            </div>

            <div class="mb-3">
                <label for="categoria" class="form-label">Categoria</label>
                <input type="text" class="form-control" value="<?php echo $categoria; ?>" name="categoria" id="categoria"
                    aria-describedby="helpId" placeholder="Salado">

            </div>

            <div class="mb-3">
                <label for="stock" class="form-label">Stock</label>
                <input type="text" class="form-control" value="<?php echo $stock; ?>" name="stock" id="stock"
                    aria-describedby="helpId" placeholder="666">
